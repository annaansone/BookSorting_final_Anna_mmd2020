...
//adding new book titles and authors to the table

function addnew() {
var newtit = document.getElementById('add').value = prompt('TITLE OF THE BOOK:')
var newaut = document.getElementById('add').value = prompt('AUTHOR OF THE BOOK:')

let r = document.createElement('tr');
    let d = document.createElement('td');
    let t = document.createTextNode(`${newtit} `);
    d.appendChild(t);
    r.appendChild(d);
    d = document.createElement('td');
    let i = document.createElement('i');
    t = document.createTextNode(`${newaut}`);
    i.appendChild(t);
    d.appendChild(i);
    r.appendChild(d);
    $("display").appendChild(r);

 document.getElementById("newbook").innerHTML = newtit + " " + newaut + " is added to the list";
};
